...
import { getNotificationsMock, NOTIFICATION_LIMIT } from "./constants";
import { TEST_IDS } from "./stub";
import { NotificationWrapper, StyledPopOver } from "./StyledNotification";
...
// TODO
class Notification extends React.Component<unknown, IState> {
  newNotificationsCursor;
